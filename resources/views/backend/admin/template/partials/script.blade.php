...
<script src="{{url('backend/assets/js/plugins/bootstrap-switch.js')}}"></script>

<!--  Plugin for Sweet Alert -->
<script src="{{url('backend/assets/js/plugins/sweetalert2.min.js')}}"></script>
...
<script src="{{url('/backend/assets/js/plugins/bootstrap-datetimepicker.js')}}"></script>
...
<!-- Sharrre libray -->
<script src="{{url('/backend/assets/demo/jquery.sharrre.js')}}"></script>
