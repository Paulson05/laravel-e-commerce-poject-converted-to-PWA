...
<script src="{{asset('/backend/assets/js/now-ui-dashboard.minaa26.js?v=1.5.0')}}" type="text/javascript"></script><!-- Now Ui Dashboard DEMO methods, don't include it in your project! -->
